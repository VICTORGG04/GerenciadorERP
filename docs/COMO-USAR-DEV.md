...
2. **Criar a planilha**
   ...
   - Crie a aba `Licença`
   - Na aba `Licença`, crie uma Tabela (Insert > Table) nomeada `DADOS` com as colunas: Token, CNPJ, Empresa, Plano, Validade, Status, Maquina_ID, Hostname, IP, Ativado_Em, Logradouro, Numero, Complemento, Bairro, Cidade, UF, CEP, Contato, Email, Telefone, Obs
