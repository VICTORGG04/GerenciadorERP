# -*- encoding: utf-8 -*-
# stub: google-apis-core 1.2.3 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<addressable>.freeze, ["~> 2.9"])
  s.add_runtime_dependency(%q<faraday>.freeze, ["~> 2.13"])
  s.add_runtime_dependency(%q<faraday-follow_redirects>.freeze, ["~> 0.3"])
  s.add_runtime_dependency(%q<googleauth>.freeze, ["~> 1.14"])
  ...
  s.add_runtime_dependency(%q<retriable>.freeze, [">= 3.1", "< 5.0"])
end
